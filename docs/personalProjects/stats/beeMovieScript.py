...
is automatically color-corrected, scent-adjusted and bubble-contoured into this soothing sweet syrup
...
for i in range(len(bee)):
	if bee[i]=="O" and bee[i+1]!="f" and bee[i+1]!="u" and bee[i+1]!="w":
		bee = bee[:i] + "C" + bee[i + 1:]
print(bee)
engine.say(bee)
engine.runAndWait()
